            ...
            <ScrollView
                        ...
                        <View className="flex-row items-center">
                            <View className="relative">
                                <Image
                                    ...
                                    transition={200}
                                />
                                <View className="absolute bottom-1 right-1 size-7 items-center justify-center rounded-full border-2 bg-primary">
                ...
                <View className="mx-6 mb-3 flex-row flex-wrap gap-2">
                    {MENU_ITEMS.map((item) => (
                        <TouchableOpacity
                            key={item.id}
                            className="items-center justify-center rounded-2xl bg-gray-50 p-6"
                            style={{ width: '48%' }}
                            activeOpacity={0.7}
                ...
                {/* NOTIFICATONS BTN */}
                <View className="bg-gray-50 mx-6 mb-3 rounded-2xl p-4">
                    <TouchableOpacity
                        className="flex-row items-center justify-between py-2"
                        activeOpacity={0.7}>
                        <View className="flex-row items-center">
                            <Ionicons name="notifications-outline" size={22} color="#111" />
                            <Text className="text-text-primary ml-3 font-semibold">
                                Notifications
                            </Text>
                        </View>
                ...
                {/* SIGNOUT BTN */}
                <TouchableOpacity
                    className="bg-gray-50 mx-6 mb-3 flex-row items-center justify-center rounded-2xl border-2 border-red-500/20 py-5"
                    activeOpacity={0.8}
                    onPress={() => signOut()}
                >
                ...
                <Text className="text-text-secondary mx-6 mb-3 text-center text-xs">
                    Version 1.0.0
                </Text>
            </ScrollView>
        </SafeScreen>
